...
function mytheme_add_admin() {
	...
	add_theme_page( $themename, $themename, $capability, $menu_slug, $function );
...
<!-- START NORMAL-admincp-box div -->              
                ...
                <tr>
                  ...
                  <div class="box-content">
                    ...
                    <td>&nbsp;
                      <input class="upload_image_reset button" type="button" value="清除" />
                      <input class="upload_image_button button" type="button" value="上传图片" />
                    </td>
                    </tr>
                    </table>
                    <div class="clear"></div>
...
<?php }//end  options jugement
      ...
      <div id="admincp-bottom">
        ...
        <input name="reset" type="button" value="恢复默认设置" class="defaults-button  button"/>&nbsp;
        <input name="save" type="submit" value="保存设置" id="admincp-save" class="button button-primary"/>
